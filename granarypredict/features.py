        ...
        with ProcessPoolExecutor(max_workers=max_workers) as executor:
            ...
            for lag_days, future in futures:
                try:
                    ...
                    _toast_notify(f"⚠️ Lag {lag_days}d failed, using sequential fallback", "⚠️")
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            for group_key, future in futures:
                try:
                    ...
                    _toast_notify(f"⚠️ Rolling stats failed for sensor group, using sequential fallback", "⚠️")
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            for group_key, future in futures:
                try:
                    ...
                    _toast_notify(f"⚠️ Stability features failed for sensor group, using sequential fallback", "⚠️")
                    # Fall back to sequential for this group
                    group_df = groups.get_group(group_key)
