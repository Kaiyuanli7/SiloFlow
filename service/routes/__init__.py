...
from routes.process import router as process_router  # noqa: F401
from routes.sort import router as sort_router  # noqa: F401
...
router = APIRouter()
for r in [health_router, models_router, train_router, process_router, sort_router, pipeline_router, forecast_router]:
